...
class _AddOrderScreenState extends State<AddOrderScreen>
  ...
  final _formKey4 = GlobalKey<FormState>(); // Measurements form
  ...
  void _nextStep() {
    ...
    if (_currentStep == 2 && !_formKey4.currentState!.validate()) return;
  ...
  void _confirmOrder() async {
    ...
    try {
      final orderId = await _orderController.addOrder(order: order, customer: customer);

      // Build the saved order & customer for the receipt
      ...
      // Send text confirmation to WhatsApp if phone is available
      if (customer.phone.isNotEmpty) {
        await WhatsAppService.sendNewOrderMessage(
                  ...
                  children: [
                    ...
                    TextField(
                      decoration: InputDecoration(
                        ...
                        hintStyle: GoogleFonts.inter(color: kTextSec),
                        prefixIcon: const Icon(Icons.search, color: kTextSec),
                        filled: true,
                    ...
                    Expanded(
                      child: AnimatedBuilder(
                        ...
                        builder: (context, _) {
                          ...
                          final filteredCustomers = _orderController.customers.where((c) {
                            return c.id.toLowerCase().contains(searchQuery) ||
                          ...
                          return ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                ...
                                subtitle: Text(
                                  'ID: ${c.id}${c.phone.isNotEmpty ? '  •  ${c.phone}' : ''}',
                                  style: GoogleFonts.inter(
                                    color: kTextSec,
                                    fontSize: 12,
                                  ),
                ...
                children: [
                  _InputField(
                    ...
                    validator: (v) {
                      ...
                      final inputId = v.trim();
                      if (_selectedCustomer != null &&
                          _selectedCustomer!.id == inputId) {
                        return null;
                      }
                      bool exists = _orderController.customers
                          .any((c) => c.id == inputId);
                      if (exists) {
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            errorStyle: GoogleFonts.inter(fontSize: 10, color: Colors.red),
            suffixIcon: readOnly
